...
<?php get_header(); ?>
                          ...
                          <div class="main-image">
                            <div class="main-image_grid">
                              <div class="main-image__el">
                                <img class="img1" loading="lazy" src="<?php echo get_template_directory_uri()?>/static/img/img1.jpg" alt="img">
                              </div>                            
                              <div class="main-image__el">
            ...
            <section class="tarifs_desktop">
              <div class="_container">
                ...
                <div class="tabs">                  
                    <input type="radio" class="tab_btn" name="tab_btn" id="tab_btn_1" value="" checked>
                    ...
                    <input type="radio" name="tab_btn" id="tab_btn_5" value="">
                    <label for="tab_btn_5">Продвижение на картах</label>                                   
                        
                  <div id="tab_1" class="tabs_block">
                      <div class="tab_header">
                        <div class="tab_title"><a href="/services/sozdanie-sajtov/">Разработка под ключ</a></div>
                        <div class="tab_price">от <span>50 000</span> ₽</div>
                      </div>
                      <div class="tab_body">
                        Мы разрабатываем индивидуальные, готовые к использованию сайты с интерактивным функционалом под разные бизнес задачи. 
                        <br>
                        <p>Разработка сайта "под ключ" обычно включает в себя объем работ, таких как: определение целевой аудитории, дизайн, 
                          сбор семантического ядра,  создание контента, программирование и аналитика. Проект состоит из нескольких задач, 
                          каждой из которых занимается отдельный специалист. </p>   
                          <br>                     
                        <p><b>Преимущества заказа сайта под ключ:</b></p>
                        <ul>
                          <li>Экономия времени на поиск дополнительных подрядчиков т.к. над проектом уже трудится слаженно работающая команда,</li>
                          <li>Оптимизация сайта под поисковые запросы происходит еще на этапе его создания,</li>
                          <li>После анализа полученных результатов продвижения возможна корректировка работы каждого из участника проекта,</li>
                          <li>Администрирование и техническая поддержка сайта на протяжении всего времени сотрудничества.</li>
                        </ul>
                        Занимаемся созданием сайтов как в Ростове на Дону, так и по всей России. 
                      </div>
                  ...
                  <div id="tab_2" class="tabs_block">
                      <div class="tab_header">
                        <div class="tab_title"><a href="/services/seo/">SEO</a></div>
                        <div class="tab_price">от <span>21 000</span> ₽</div>
                      </div>
                      <div class="tab_body">
                        <p>SEO - продвижение - один из самых эффективных способов привлечь на сайт 
                          дополнительный трафик, используя методы, имеющие накопительный эффект. 
                          Результаты продвижения видны не сразу, однако такой метод с течением времени 
                          позволяет добиться стабильного роста продаж  и увеличения прибыли.</p>
                          <br>
                        <p>Как digital-агентство, мы помогаем организациям занять лидирующие позиции в ТОП10 
                          поисковой выдачи, повысить конверсию и увеличить прибыль в несколько раз. </p>
                          <br>
                  ...
                  <div id="tab_3" class="tabs_block">
                      <div class="tab_header">
                        <div class="tab_title"><a href="/services/reklama/">Контекстная реклама</a></div>
                        <div class="tab_price">от <span>25 000</span> ₽ / месяц</div>
                      </div>
                      <div class="tab_body">
                        <b>Контекстная реклама – это:</b>
                        <ul>
                          <li>Онлайн-реклама, показываемая  
                            пользователям, использующим конкретные ключевые запросы при поиске, то есть реклама со своей целевой аудиторией</li>
                          <li>Вариант, который позволяет снизить рекламные расходы при правильном ведении контекстной рекламы: настройке  ставок и постоянном анализе результатов кампании</li>
                          <li>Быстрый способ получения качественного трафика по мере пополнения рекламного бюджета</li>
                        </ul>
                        <b>Разработка контекстной интернет рекламы поможет:</b>
                        <ul>
                          <li>добиться повышения лояльности пользователей</li>
                          <li>улучшить имидж компании</li>
                          <li>повысить конверсию в продажи</li>
                        </ul>
                        Вы можете заказать интернет рекламу сайта в нашем агентстве Topland.
                      </div>
                      <div class="tab_footer">
                        <div class="tab_btn">
                  ...
                  <div id="tab_4" class="tabs_block">
                      <div class="tab_header">
                        <div class="tab_title"><a href="/services/marketplaces/">Маркетплейсы</a></div>
                        <div class="tab_price">от <span>25 000</span> ₽</div>
                      </div>
                      <div class="tab_body">
                        <b>Маркетплейсы - это:</b>
                        <ul>
                          <li>Площадки для селлеров, позволяющие начать продажи без создания собственного интернет магазина. 
                            Достаточно оформить витрину с товарами в своем личном кабинете</li>
                          <li>Вариант быстрой интеграции бизнеса в интернет пространство</li>
                        </ul>
                        <p>В связи с увеличивающейся конкуренции недостаточно просто выложить изображения товаров на свою страницу.
                           Для увеличения продаж на маркетплейсах, необходимо обратиться к дизайнеру, seo-специалисту и копирайтеру, 
                           которые создадут качественный контент и настроят продвижение карточек товаров.</p><br>
                        <p>Наше digital агентство готово полностью взять на себя ведение Вашего личного кабинета на Wildberries и Ozon.</p>
                      </div>
                      <div class="tab_footer">
                        <div class="tab_btn">
                  ...
                  <div id="tab_5" class="tabs_block">
                      ...
                      <div class="tab_body">
                        ...
                        в определенном регионе и основана на использовании местных поисковых запросов (например, 
                        "рестораны в Ростове"). Они помогают привлечь целевую аудиторию, увеличить рейтинг в поисковых 
                        системах и увеличить конверсию продаж.</p>
                        <br>
                        <p>Комплексное  продвижение на Яндекс Картах, GoogleMaps может помочь бизнесу увеличить узнаваемость 
                          бренда и привлечь новых клиентов благодаря использованию:</p>
                          <ul>
                            <li>SEO-продвижения</li>
                            <li>Контекстной рекламы</li>
                            <li>Таргетированной рекламы</li>
                          </ul>
                          <p>Гео-ориентированная реклама может оказаться эффективной не только для малых бизнесов, но и 
                            для крупных компаний, особенно тех, которые действуют на местном уровне.</p>
                      </div>
                      <div class="tab_footer">
                        <div class="tab_btn">
            ...
            <section class="tarifs_mobile" >
              <div class="_container">
                ...
                <div class="accordion">
                  ...
                  <input type="checkbox" name="chacor" id="step_5" />
                  <label for="step_5">Продвижение на картах</label>
                  <div class="acor-body">
                  <div class="tab_header">
                  <div class="tab_title">Продвижение на картах</div>
                        <div class="tab_price">от <span>20 000</span> ₽</div>
                      </div>
                      <div class="tab_body">
                        <p><b>Гео продвижение</b> - это маркетинговая стратегия, направленная на продвижение бизнеса 
