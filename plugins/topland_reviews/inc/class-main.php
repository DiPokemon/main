...
public function __construct( $file ){
	...
	// Model
	self::$model = new ToplandReviewsModel();
	...
	// Shortcodes
    add_shortcode('topland_reviews', array(__CLASS__, 'replace_shortcode') );
}
...
function activate(){
	...
	if ($wpdb->get_var("SHOW TABLES LIKE '" . TOPLAND_REVIEWS_DB_TABLE_NAME . "'") != TOPLAND_REVIEWS_DB_TABLE_NAME)
	{
		...
		// Назначение dbDelta: создание и обновление таблицы
      	...
      	add_option(TOPLAND_REVIEWS_PLUGIN_NAME . "_db_version", TOPLAND_REVIEWS_PLUGIN_DB_VERSION);
	}
}
